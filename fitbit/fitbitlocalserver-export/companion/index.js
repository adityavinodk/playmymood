...
myHeaders.append(
  "Authorization",
  "Basic " + APIClientCredentials.base64UserPassword
);
...
messaging.peerSocket.onmessage = (evt) => {
  //  var a = JSON.stringify(evt.data);
  var b = JSON.parse(evt.data);
  var c = JSON.stringify(b.data);
  var url = APIClientCredentials.host;
  fetch(url, {
    method: "POST",
    headers: myHeaders,
    body: c,
    ...
    .then(function (data) {
      console.log("Got response from server:", JSON.stringify(data)); // Log in
